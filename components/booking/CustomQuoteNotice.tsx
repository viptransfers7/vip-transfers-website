export function CustomQuoteNotice({ reason }: { reason?: string }) {
  return (
    <div className="border-l-2 border-champagne bg-ivory p-5">
      <div className="text-sm font-black uppercase tracking-[0.14em] text-[#9a7b41]">Custom quote required</div>
