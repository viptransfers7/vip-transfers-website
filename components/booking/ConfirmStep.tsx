...
export function ConfirmStep({
  ...
  return (
    <div>
      <h1 className="serif-title text-3xl md:text-4xl">Confirm booking</h1>
      <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
        <div className="grid gap-5">
          ...
          <div className="border hairline bg-white p-4 md:p-5">
            <div className="text-xs font-black uppercase tracking-[0.16em] text-[#9a7b41]">Review</div>
            <div className="mt-3 grid gap-1 text-sm">
              {rows.map(([label, value]) => (
                <div key={label} className="grid gap-1 border-t hairline py-2.5 sm:grid-cols-[120px_1fr]">
        ...
        <aside className="grid content-start gap-4 xl:sticky xl:top-28">
          ...
          <div className="border hairline bg-[#fbfaf6] p-4">
            <div className="text-xs font-black uppercase tracking-[0.16em] text-[#9a7b41]">{quote?.requiresCustomQuote ? "Concierge quote" : "Secure payment"}</div>
            ...
            <button type="button" onClick={onSubmit} disabled={cannotSubmit} className="btn btn-dark mt-5 w-full">
