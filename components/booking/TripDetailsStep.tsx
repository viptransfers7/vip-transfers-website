...
export function TripDetailsStep({
  ...
  return (
    <div>
      <h2 className="serif-title text-2xl md:text-3xl">Trip details</h2>
      <div className="mt-4 grid grid-cols-2 gap-3 md:mt-5 md:gap-4">
        ...
        {isAirport ? (
          <div className="col-span-2 flex items-center justify-between gap-3 border hairline bg-white p-1 text-sm font-bold">
            <span className="pl-3 text-xs font-black uppercase tracking-[0.12em] text-neutral-500">Airport ride</span>
            <div className="grid min-w-[188px] grid-cols-2">
              {[
                ["arrival", "From"],
                ["departure", "To"]
              ].map(([value, title]) => (
                <button
                  ...
                  className={`h-10 px-3 text-center text-sm font-black ${trip.airportDirection === value ? "bg-ivory text-black" : "text-neutral-500"}`}
                >
                  {title}
                </button>
              ))}
        ...
        {isAirport ? (
          <label className="col-span-2 flex flex-wrap items-center gap-3 border hairline bg-ivory p-4 text-sm font-bold">
            ...
            <span className="ml-auto text-[#9a7b41]">10% round-trip discount</span>
          </label>
        ) : null}
        ...
        {isAirport && trip.isRoundTrip ? (
          <>
            <div className="col-span-2 mt-2 border-t hairline pt-5">
              <div className="text-xs font-black uppercase tracking-[0.14em] text-[#9a7b41]">Return transfer</div>
