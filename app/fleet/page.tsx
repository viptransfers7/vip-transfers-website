    ...
    <main>
      <section className="section bg-ink text-white">
        <div className="container">
          ...
          />
          <div className="mt-7 grid gap-3 text-sm text-white/76 md:mt-10 md:grid-cols-3">
            {[
              ...
              <div key={title} className="surface-card-dark p-4 md:p-5">
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="mt-8 border-l-2 border-champagne bg-ivory p-4 text-sm leading-6 text-neutral-700 md:mt-10 md:p-5">
